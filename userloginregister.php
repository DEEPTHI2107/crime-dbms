...
<body>
<!-- main -->
<center><h1 style="color:black;">CRIME PORTAL</h1></center>
<br>
<div><h2 style="color:black;"><a href="index.php">BACK</a></h2></div>
<h1 style="color:black;">USER REGISTER</h1>
...
<br>
<input type="password" name="password" placeholder="Enter Your Password"><br><span class="error"><?php echo $usernameErr;?></span>
</div>
<input type="submit" value="SUBMIT">
<center><a href="userreg.php">New User? Register here!!</a></center>
<br>
</form>
