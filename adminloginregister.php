...
if (!empty($_POST["username"]) && !empty($_POST["password"]))
{
    ...
    $sql = "SELECT password from admin where admin_id='$uname'";
    $result=$conn->query($sql);
    $row=$result->fetch_assoc();
    if($row["password"]==$pass){
		$_SESSION['user_name']= $uname; 
        header("Location: adminwelcome.php?q=$uname"); 
	}
    else {
...
<body>
<!-- main -->
<center><h1>CRIME PORTAL</h1></center>
<div><h2 style="color:white"><a href="index.php">BACK</a></h2></div>
