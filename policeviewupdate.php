...
html { 
  background: url(33.jpg) no-repeat center center fixed; 
...
<label style="color:black;"> phone </label>
				 <input type="text" name="phone" placeholder="phone" value="<?php echo $phone; ?>"><span class="error">* <?php echo $phoneErr;?></span>
<br>
<br>
<label style="color:black;"> specalization</label> <?php echo $spec; ?> <br> &nbsp;&nbsp;&nbsp;<select name="specialization">
...
<br>
<input type="button" value="Back" onclick="location.href='policewelcome.php?q=<?php echo $login_user; ?>';" style="width:65px;"><br><span class="success"><?php echo $successMsg;?></span><span class="error"><?php echo $errorMsg;?></span></td></tr>
