...
if (!empty($_POST["status"]) && $statusErr == "")
{
    ...
    $sql = "SELECT * from complaint WHERE year(datetime) = '$status'";
...
<html>
    ...
    <body>
        ...
        <h3><center>SEARCH BY YEAR</center></h3>
		<div style="margin-top: 10px;height: 300px; width: 800px; margin-right:470px;">
			...
			<center>	<table border="0.0" style="margin-left:480px; height:200px;width:600px;color:black;font:white;">
					<tr><td >&nbsp;&nbsp;ENTER YEAR:</td><td>&nbsp;&nbsp;&nbsp;<input type="text" name="status" placeholder="FORMAT:2018"><span class="error">* <?php echo $statusErr;?></span></td></tr>
