...
$sql = "SELECT * FROM complaint WHERE status IN ('CLOSED')  ORDER BY datetime";
...
if ($result->num_rows > 0) {
	...
	$errorMsg = "No closed Complaints in the system at this point!!!";
}
$conn->close();
?>
<!DOCTYPE html>
<html>
    ...
    <body style="background-color:black;">
        ...
        <h2 style="margin-left:460px;font:bold;font-size:45px; color:white;">All closed Complaints</h2>
		<br><br>
