...
<input type="text" name="name" placeholder="name" value="<?php echo $name;?>"><span class="error">* <?php echo $nameErr;?></span>
					<input type="text" name="username" placeholder="Remember your username" value="<?php echo $username;?>"><span class="error">* <?php echo $usernameErr;?>
					<input type="password" name="password" placeholder="Remember your password" ><span class="error">* <?php echo $passwordErr;?></span>
					<input type="text" name="address" placeholder="address" value="<?php echo $address;?>"><span class="error">* <?php echo $addressErr;?></span>
				    <input type="text" name="pincode" placeholder="pincode" value="<?php echo $pincode;?>"><span class="error">* <?php echo $pincodeErr;?></span>
...
<h4 style="color:white;">mention your gender</h4><span class="error">* <?php echo $genderErr;?></span>
				    <input type="radio" name="gender"  <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">Female
					<input type="radio" name="gender" style="color:white;" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male">Male
				   <input type="submit" name="submit" value="Submit">

<input type="button" value="Exit" onclick="location.href='mainpage.html';" style="width:65px;"><br><span class="success"><?php echo $successMsg;?></span><span class="error"><?php echo $errorMsg;?></span></td></tr>
